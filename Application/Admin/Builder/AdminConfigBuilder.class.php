...
class AdminConfigBuilder extends AdminBuilder
{
    ...
    public function display()
    {
        ...
        foreach ($this->_keyList as &$e) {
            if ($e['type'] == 'multiInput' || $e['type'] == 'bdmap') {
    ...
    public function keyBDMap($name,$title,$subtitle = null){
        $this->assign('name',$name);
        $key = array('name'=>$name, 'title' => $title, 'subtitle' => $subtitle, 'type' => 'bdmap');
        $this->_keyList[] = $key;
        return $this;
    }
    public function keyRichText($name,$title,$subtitle = null){
        $this->assign('name',$name);
        $key = array('name'=>$name, 'title' => $title, 'subtitle' => $subtitle, 'type' => 'richtext');
        $this->_keyList[] = $key;
        return $this;
    }
